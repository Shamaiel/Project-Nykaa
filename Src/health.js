let healthData = [
    {
      image_url: 'https://images-static.nykaa.com/media/catalog/product/tr:w-200,h-200,cm-pad_resize/0/0/000241cBOLDF00000014creative.jpg',
      desc: "Boldfit Super Women's Whey Protein Powder - Chocolate",
      rating: '★★★★',
      price: 1180,
    ...
    {
      image_url: 'https://images-static.nykaa.com/media/catalog/product/tr:w-200,h-200,cm-pad_resize/e/a/eabb80f5056185745293.jpg',
      desc: 'Myprotein Impact Whey Protein - Chocolate Brownie',
      rating: '★★★★',
      price: 4234,
      bestseller: 'BESTSELLER',
      off:"20% OFF",
    ...
    {
      image_url: 'https://images-static.nykaa.com/media/catalog/product/tr:w-200,h-200,cm-pad_resize/1/e/1e958b68906067021526_1.jpg',
      desc: 'MuscleBlaze Raw Whey Protein - Unflavoured',
      rating: '★★★★',
      price: 2020,
      off:"40% OFF",
      bestseller: 'BESTSELLER',
...
function sortByPrice() {
    ...
    if (value === "htl") {
    var sorted = healthData.sort((a, b) => {
